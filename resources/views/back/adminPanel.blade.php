...
<head>
  ...
  <title>MasudIT | @yield('title')</title>
...
<!-- jQuery -->
<script src="{{asset('public/back/dist/js/jquery1.min.js')}}"></script>
...
{{-- <script src="{{asset('public/back/plugins/jqvmap/maps/jquery.vmap.usa.')}}"></script> --}}
<!-- jQuery Knob Chart -->
